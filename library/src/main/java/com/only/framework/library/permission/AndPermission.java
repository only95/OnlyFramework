...
import com.only.framework.library.permission.checker.PermissionChecker;
import com.only.framework.library.permission.checker.StandardChecker;
import com.only.framework.library.permission.source.ContextSource;
import com.only.framework.library.permission.source.FragmentSource;
import com.only.framework.library.permission.source.Source;
import com.only.framework.library.permission.source.SupportFragmentSource;
import com.only.framework.library.permission.runtime.Runtime;
import com.only.framework.library.permission.Setting;
import java.io.File;
