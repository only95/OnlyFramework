...
public class PayPasswordDialog extends Dialog implements View.OnClickListener {
    ...
    ForgetPassClick forgetPassClick;
    public void setOnForgetPassClick(ForgetPassClick forgetPassClick){
        this.forgetPassClick=forgetPassClick;
    }
    ...
    public interface ForgetPassClick{
